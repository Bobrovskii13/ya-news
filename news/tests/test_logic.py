...
class TestCommentCreation(TestCase):
    """Тесты логики создания комментариев к новостям."""

    COMMENT_TEXT = 'Текст комментария'

    @classmethod
    def setUpTestData(cls):
        """Тестовые данные для проверки логики создания комментариев."""
    ...
    def test_user_cant_use_bad_words(self):
        """Тест невозможности использования в комментариях стоп-слов."""
...
class TestCommentEditDelete(TestCase):
    """Тесты логики редактирования и удаления комментариев к новостям."""
    ...
    @classmethod
    def setUpTestData(cls):
        """Данные для проверки логики редактирования и удаления комментариев."""
        cls.news = News.objects.create(title='Заголовок', text='Текст')
    ...
    def test_author_can_delete_comment(self):
        """Тест успешного удаления комментария его автором."""
    ...
    def test_user_cant_delete_comment_of_another_user(self):
        """Тест удаления комментария другим авторизованным пользователем."""
    ...
    def test_author_can_edit_comment(self):
        """Тест успешного редактирования комментария его автором."""
    ...
    def test_user_cant_edit_comment_of_another_user(self):
        """Тест изменения комментария другим авторизованным пользователем."""
